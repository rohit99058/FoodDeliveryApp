...
const CarouselRestaurants = () => {
  ...
  return (
    <div>
        <Navbar />
        <div className='p-4 mb-6 w-fit mx-[30px]'>
        ...
        <div className='grid grid-cols-4'>
            {data && data.map((item) => {
                ...
                // console.log(obj)
                return <Cards area={obj.areaName} cuisines={obj.cuisines} id={obj.id} img={obj.cloudinaryImageId} c={"tr"} name={obj.name} time={obj.sla.deliveryTime} rating={obj.avgRating} />
            })}
        </div>
    </div>
  )
